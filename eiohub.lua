...
local GameSpecific = Window:NewTab("Game-Specific")
local IMPORTANTSection = IMPORTANT:NewSection("IMPORTANT")
local UniversalSection = Main:NewSection("The Big Book of Trolls")
local GeneralSection = GameSpecific:NewSection("Everything Game Specific.")
-- IMPORTANT scripts
...
IMPORTANTSection:NewKeybind("Toggle UI", "Toggles the UI.", Enum.KeyCode.LeftControl, function()
Library:ToggleUI()
end)
--UniversalScripts
GeneralSection:NewLabel("This is a snapshot! You may encounter bugs!")
UniversalSection:NewLabel("This is a snapshot! You may encounter bugs!")
UniversalSection:NewLabel("Join the discord! https://discord.gg/nd9653WUpA")
GeneralSection:NewLabel("Join the discord! https://discord.gg/nd9653WUpA")
UniversalSection:NewSlider("Walkspeed", "Change how fast you run.", 155, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
...
UniversalSection:NewButton("Godsaggie's Universal Hub V4", "Saggie's hub. Nigg-", function()
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("Saggies UniversalV2", "BloodTheme")
UniversalSection:NewButton("Universal ESP", "Works on any game.", function()
...
MainSection:NewButton("Infinite Yield", "Works On Most Games", function()    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)



MainSection:NewButton("Fling Punch", "Collison Has to be enabled and this only works for r6", function()
    loadstring(game:HttpGet(('https://pastefy.ga/GvnHVjT5/raw'),true))()
end)



MainSection:NewButton("SimpleSpy", "Allows you to spy on remote events", function()    --[[
    SimpleSpy v2.2 SOURCE
...
MainSection:NewKeybind("Toggle UI", "Closes the ui", Enum.KeyCode.P, function()Library:ToggleUI()end)
end)

--Big Paintball Scripts
GeneralSection:NewButton("OwlHub", "Gives you silent aim, ESP, tracers, and more. Just your default GUI.", function()
...
--GameSpecific Scripts
GeneralSection:NewButton("SCP-3008 GUI", "Literally makes you god.", function()
  loadstring(game:HttpGet'https://raw.githubusercontent.com/RunDTM/scripts/main/3008.lua')()
end)
GeneralSection:NewButton("Doors GUI", "Literally makes you god... incarnate.", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Vynixius/main/Doors/Script.lua"))()
end)
GeneralSection:NewButton("Driving Simulator GUI", "Literally makes you god... incarnate x2.", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptpastebin/raw/main/20"))()
end)
GeneralSection:NewButton("Strongman Simulator GUI", "I'm done. Its just a GUI.", function()
...
GeneralSection:NewButton("Typical Colors 2 GUI", "God.", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Trashjpg/Rage/main/TC2.lua"))()
end)
GeneralSection:NewButton("Military Tycoon GUI", "Requires a key.", function()
loadstring(game:HttpGet"https://thedragonslayer2.github.io")()
end)
GeneralSection:NewButton("Murder Mystery 2 GUI", "God.", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Doggo-cryto/EclipseMM2/master/Script", true))() 
end)
GeneralSection:NewButton("SCP 3008 Gui", "God.", function()
loadstring(game:HttpGet'https://raw.githubusercontent.com/RunDTM/scripts/main/3008.lua')()
end)
GeneralSection:NewButton("Break In GUI", "God.", function()
...
--My Brother's Script
GeneralSection:NewButton("Demonfall GUI", "Same as the name states.", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/LeadMarker/OpenSource/main/Demonfall.lua"))()
    print("Clicked")
end)
GeneralSection:NewButton("Cook Burgers GUI", "Uhhhhhhhhhhh its kinda bad", function()
end)
GeneralSection:NewButton("dizzy hub", "Works on most games, including Slap Battles.", function()
loadstring(game:HttpGet(("https://raw.githubusercontent.com/dizyhvh/rbx_scripts/main/dizzy_hub/loader.lua")))(); 

end)
GeneralSection:NewButton("K.A.T GUI", "funny", function()
loadstring(game:HttpGet(('https://raw.githubusercontent.com/rblxscriptsnet/unfair/main/rblxhub.lua'),true))()
end)
GeneralSection:NewButton("Auto Roll for ROLL The DICE", "Press E to stop the shit.", function()
--SCRIPT MADE BY ALEXI THE FEMBOY
i = 1 -- this is for the shit that runs the fucking loop lol
local uis = game:GetService("UserInputService") -- allows you to fucking close the bitch
uis.InputBegan:Connect(function(input) -- detects if the shit has an input
if input.KeyCode == Enum.KeyCode.E then -- fucking sees if the goddamn key is E
i = 2 -- stops the damn loop
end
end)
local function rolldice() -- the thing to roll the shit
repeat
game:GetService("ReplicatedStorage").RollDice:FireServer() -- rolls the shit
wait(0.2) -- so your game doesnt fucking crash
until i ~= 1 -- so loop actually fucking ends
end
rolldice() -- makes the fucking script run
end)
GeneralSection:NewButton("[LAGGY] Auto Roll for ROLL The DICE", "Press E to stop the shit.", function()
--SCRIPT MADE BY ALEXI THE FEMBOY
i = 1 -- this is for the shit that runs the fucking loop lol
local uis = game:GetService("UserInputService") -- allows you to fucking close the bitch
uis.InputBegan:Connect(function(input) -- detects if the shit has an input
...
repeat
game:GetService("ReplicatedStorage").RollDice:FireServer() -- rolls the shit
wait(0.05) -- so your game doesnt fucking crash
until i ~= 1 -- so loop actually fucking ends
end
rolldice() -- makes the fucking script run
end)
...
--Tabs
local IMPORTANT = Window:NewTab("IMPORTANT")
local Zone1 = Window:NewTab("Zone 1")
local Zone2 = Window:NewTab("Zone 2")
local Zone3 = Window:NewTab("Zone 3")
local Zone4 = Window:NewTab("Zone 4")
local Zone5 = Window:NewTab("Zone 5")
local Automation = Window:NewTab("Automation")
--Sections
local Zone1Section = Zone1:NewSection("Teleports")
local Zone2Section = Zone2:NewSection("Teleports")
local Zone3Section = Zone3:NewSection("Teleports")
local Zone4Section = Zone4:NewSection("Teleports")
local Zone5Section = Zone5:NewSection("Teleports")
local IMPORTANTSection = IMPORTANT:NewSection("IMPORTANT")
...
--Dropdowns
--Buttons.
AutomationSection:NewButton("[POTENTIALLY LAGGY] Auto Rebirth", "Press Z to stop the shit. Best used with Auto Fight.", function()
--SCRIPT MADE BY ALEXI THE FEMBOY
i = 1
...
repeat
game:GetService("ReplicatedStorage").Remotes.Events.RequestRebirth:FireServer()
wait(5)
until i ~= 1
end
rebirth()
end)
AutomationSection:NewButton("[POTENTIALLY LAGGY] Auto Train", "Press Q to stop the shit.", function()
--SCRIPT MADE BY ALEXI THE FEMBOY
i = 1
local uis = game:GetService("UserInputService")
uis.InputBegan:Connect(function(input)
...
game:GetService("ReplicatedStorage").Remotes.Events.Click:FireServer(unpack(args))
wait(0.1)
until i ~= 1
end
train()
end)
Zone1Section:NewButton("Teleport to Park", "Teleports you to Zone 1.", function()
local args = {
    [1] = "Park"
}
...
Zone1Section:NewLabel("Fights")
Zone1Section:NewButton("Fight Nerd", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Nerd"
    }
...
Zone1Section:NewButton("Fight Steve", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Steve"
    }
...
Zone1Section:NewButton("Fight Dwayne", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Dwayne"
    }
...
Zone1Section:NewButton("Fight Farmer", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Farmer"
    }
...
Zone1Section:NewButton("Fight Bacon Chad", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "BaconChad"
    }
...
Zone2Section:NewButton("Teleport to Desert", "Teleports you to Zone 2.", function()
local args = {
    [1] = "Desert"
}
...
Zone2Section:NewLabel("Fights")
Zone2Section:NewButton("Fight Tango", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Tango"
    }
...
Zone2Section:NewButton("Fight Lil Cactus", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Cactus"
    }
...
Zone2Section:NewButton("Fight Cowboy", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Cowboy"
    }
...
Zone2Section:NewButton("Fight Egyptian Warrior", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "EgyptianWarrior"
    }
...
Zone2Section:NewButton("Fight Egyptian God", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "EgyptianGod"
    }
...
Zone3Section:NewButton("Teleport to Winter", "Teleports you to Zone 3.", function()
local args = {
    [1] = "Winter"
}
...
Zone3Section:NewLabel("Fights")
Zone3Section:NewButton("Fight Jack Frost", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "JackFrost"
    }
...
Zone3Section:NewButton("Fight Frosty", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Frosty"
    }
...
Zone3Section:NewButton("Fight Ice Cube", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "IceCube"
    }
...
Zone3Section:NewButton("Fight Yeti", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Yeti"
    }
...
Zone3Section:NewButton("Fight Snow Golem", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "SnowGolem"
    }
...
Zone4Section:NewLabel("Fights")
Zone4Section:NewButton("Fight Lava Girl", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "LavaGirl"
    }
...
Zone4Section:NewButton("Fight Torchy", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "Torchy"
    }
...
Zone4Section:NewButton("Fight Lava Warrior", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "LavaWarrior"
    }
...
Zone4Section:NewButton("Fight Skull Rider", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "SkullRider"
    }
...
Zone4Section:NewButton("Fight Lava Golem", "Does as the name states.", function()
-- Script made by Alexi The Femboy
local args = {
    [1] = "LavaGolem"
    }
